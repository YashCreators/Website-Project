...
function animationSlides(){
    ...
    sliders.forEach((slide , index , slides) => {
        ...
        //below line is for to reverse animation of previos slide
...
function navToggle(e){
    ...
    gsap.to('.line1', 0.5 , {rotate : "45" , background : 'black'});
    ...
    gsap.to('.line1', 0.5 , {rotate : "0" , background : 'white'});
    gsap.to('.line2', 0.5 , {rotate : "0" , background : 'white'});
...
function detailAnimation(){
    ...
    slides.forEach((slide , index , slides) => {
        ...
        slideTl.fromTo(nextImg , { x: '75%'} , { x : '0'})
        //scene
